...
CONFIG_STRING="${market_id}_${date}_${market_segment_id}_${security_id}_${model_type}_kfolds${kfolds}_n_estimators${n_estimators}_max_samples${max_samples}_max_features${max_features}_gamma${gamma}_n_neighbors${n_neighbors}"
