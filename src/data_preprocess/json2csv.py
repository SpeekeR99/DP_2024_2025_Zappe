...
print("Loading data...")
with open(f"data/{MARKET_ID}_{DATE}_{MARKET_SEGMENT_ID}_{SECURITY_ID}_detailed.json", "r") as fp:
    data = json.load(fp)
print("Data loaded")

print("Writing to csv...")
fp_order_add = open(f"data/{MARKET_ID}_{DATE}_{MARKET_SEGMENT_ID}_{SECURITY_ID}_ORDER_ADD.csv", "w")
fp_order_add.write("ID,TrdRegTSTimeIn,SecurityID,TrdRegTSTimePriority,DisplayQty,Side,OrdType,Price\n")
fp_order_modify = open(f"data/{MARKET_ID}_{DATE}_{MARKET_SEGMENT_ID}_{SECURITY_ID}_ORDER_MODIFY.csv", "w")
...
fp_order_modify_same_priority = open(f"data/{MARKET_ID}_{DATE}_{MARKET_SEGMENT_ID}_{SECURITY_ID}_ORDER_MODIFY_SAME_PRIORITY.csv", "w")
...
fp_order_delete = open(f"data/{MARKET_ID}_{DATE}_{MARKET_SEGMENT_ID}_{SECURITY_ID}_ORDER_DELETE.csv", "w")
fp_order_delete.write("ID,TrdRegTSTimeIn,TransactTime,SecurityID,TrdRegTSTimePriority,DisplayQty,Side,OrdType,Price\n")
fp_order_mass_delete = open(f"data/{MARKET_ID}_{DATE}_{MARKET_SEGMENT_ID}_{SECURITY_ID}_ORDER_MASS_DELETE.csv", "w")
fp_order_mass_delete.write("ID,SecurityID,TransactTime\n")
fp_partial_order_execution = open(f"data/{MARKET_ID}_{DATE}_{MARKET_SEGMENT_ID}_{SECURITY_ID}_PARTIAL_ORDER_EXECUTION.csv", "w")
...
fp_full_order_execution = open(f"data/{MARKET_ID}_{DATE}_{MARKET_SEGMENT_ID}_{SECURITY_ID}_FULL_ORDER_EXECUTION.csv", "w")
...
fp_execution_summary = open(f"data/{MARKET_ID}_{DATE}_{MARKET_SEGMENT_ID}_{SECURITY_ID}_EXECUTION_SUMMARY.csv", "w")
...
fp_auction_best_bid_offer = open(f"data/{MARKET_ID}_{DATE}_{MARKET_SEGMENT_ID}_{SECURITY_ID}_AUCTION_BEST_BID_OFFER.csv", "w")
...
fp_auction_clearing_price = open(f"data/{MARKET_ID}_{DATE}_{MARKET_SEGMENT_ID}_{SECURITY_ID}_AUCTION_CLEARING_PRICE.csv", "w")
...
fp_top_of_book = open(f"data/{MARKET_ID}_{DATE}_{MARKET_SEGMENT_ID}_{SECURITY_ID}_TOP_OF_BOOK.csv", "w")
fp_top_of_book.write("ID,TransactTime,SecurityID,BidPx,OfferPx,BidSize,OfferSize\n")
fp_instrument_state_change = open(f"data/{MARKET_ID}_{DATE}_{MARKET_SEGMENT_ID}_{SECURITY_ID}_INSTRUMENT_STATE_CHANGE.csv", "w")
...
fp_trade_report = open(f"data/{MARKET_ID}_{DATE}_{MARKET_SEGMENT_ID}_{SECURITY_ID}_TRADE_REPORT.csv", "w")
...
fp_instrument_summary = open(f"data/{MARKET_ID}_{DATE}_{MARKET_SEGMENT_ID}_{SECURITY_ID}_INSTRUMENT_SUMMARY.csv", "w")
